...
//import com.ycl.framework.BuildConfig;

/**
 * Fresco配置 by yuchaoliang on 16/4/18.
 */

public class ConfigConstants {
//    private static final int MAX_HEAP_SIZE = (int) Runtime.getRuntime().maxMemory();//分配的可用内存
//    public static final int MAX_MEMORY_CACHE_SIZE = MAX_HEAP_SIZE / 3;//使用的缓存数量
//
...
//
//
//    private static final String IMAGE_PIPELINE_SMALL_CACHE_DIR = "";//小图所放路径的文件夹名
