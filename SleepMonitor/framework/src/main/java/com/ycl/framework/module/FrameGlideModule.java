...
public class FrameGlideModule implements GlideModule {
    ...
    public void applyOptions(Context context, GlideBuilder builder) {
        File dir = FileUtils.getOwnCacheDirectory(context, "YuHua/Cache");
        if (dir != null)
            builder.setDiskCache(new DiskLruCacheFactory(dir.getAbsolutePath(), 2000 * 1024 * 1024));  //设置 缓存目录 已经大小
