...
public class PhotoBrowserActivity extends FrameActivity {
    ...
    public void initViews() {
        ...
        mSvpPager.setOnPageChangeListener(new OnPageChangeListener() {
            @Override
    ...
    private class ImageBrowserAdapter extends PagerAdapter {
        ...
        public View instantiateItem(ViewGroup container, int position) {
            ...
            GlideProxy.loadImgForUrl(photoView,"http://source.icangke.com/" + imagesList.get(position).getPath() + "?interlace/1");
