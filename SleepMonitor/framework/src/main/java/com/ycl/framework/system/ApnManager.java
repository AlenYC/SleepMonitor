...
public class ApnManager {
    ...
    public boolean checkAPNisTrue(APNEntity apn, APNType type) {
        if (apn == null) {
            LogUtil.e("ApnManager", "checkAPNisTrue false,apn is null");
            return false;
            ...
            LogUtil.w("ApnManager", "checkAPNisTrue false, apn.mcc or apn.mnc is wrong");
            return false;
        }
    }
    ...
    public ApnAccessorType getAPNType() {
        try {
            ...
            LogUtil.w("ApnManager", "getAPNType error", var2);
        }
    ...
    public APNEntity getDefaultAPN() {
        try {
            ...
            if (null == networkInfo) {
                ...
                LogUtil.d("ApnManager", "getDefaultAPN | network info is null");
