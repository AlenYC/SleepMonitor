...
public class SpanUtils {
    ...
    public static void addHyperlinks(final TextView textView, final int start, final int end, String urlH5, String context) {
        SpannableString sp = new SpannableString(context);
        //    sp.setSpan(new URLSpan(urlH5), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);     //网络
        sp.setSpan(
                new ForegroundColorSpan(Color.parseColor("#c3a753")), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
    ...
    public static void addSpanForDynamic(final TextView textView, final int startColor, final int endColor, int colors, View.OnClickListener listener, View.OnClickListener listener2) {
        ...
        sp.setSpan(
                new ForegroundColorSpan(0xff333333), endColor, mString.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        textView.setText(sp);
