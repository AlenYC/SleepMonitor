...
public class SelectorUtil {
    ...
    public static ColorStateList getColorListState(Context ctx, int defaultid, int pressid) {
        ...
        int[] colors = new int[]{ctx.getResources().getColor(defaultid), ctx.getResources().getColor(pressid),
                ctx.getResources().getColor(defaultid)};
    ...
    public static ColorStateList getColorStateListSelected(Context ctx, int defaultid, int selectid) {

        int[] colors = new int[]{selectid,
                defaultid};
        int[][] states = new int[2][];
