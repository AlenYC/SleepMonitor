...
public class PtrRefreshRecyclerView extends FrameLayout {
    ...
    protected void initViews() {
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.ptr_frame_refresh_recycler);
        ...
        if (mAdapter != null) {
            dataObserver = new RecyclerView.AdapterDataObserver() {
                ...
                public void onItemRangeChanged(int positionStart, int itemCount) {
                    ...
                    YisLoger.debug("onItemRangeChanged =          ");
                ...
                public void onItemRangeInserted(int positionStart, int itemCount) {
                    ...
                    YisLoger.debug("onItemRangeInserted =          ");
                    updateHelperDisplays();
                }
                ...
                public void onItemRangeRemoved(int positionStart, int itemCount) {
                    ...
                    YisLoger.debug("onItemRangeRemoved   =          ");
                    updateHelperDisplays();
                }
                ...
                public void onItemRangeMoved(int fromPosition, int toPosition, int itemCount) {
                    ...
                    YisLoger.debug("onItemRangeMoved =          ");
                    updateHelperDisplays();
                }
