...
public class RoundedDrawable extends Drawable {
    ...
    public static Drawable fromDrawable(Drawable drawable) {
        if (drawable != null) {
            ...
            Bitmap bm = drawableToBitmap(drawable, 5);
            if (bm != null) {
    ...
    public static Bitmap drawableToBitmap(Drawable drawable, int retryCount) {
        ...
        try {
            ...
            if (retryCount > 0) {
                System.gc();
                return drawableToBitmap(drawable, retryCount - 1);
            } else {
                return null;
            }
        }
    ...
    public Bitmap toBitmap() {
        return drawableToBitmap(this, 5);
    }
}